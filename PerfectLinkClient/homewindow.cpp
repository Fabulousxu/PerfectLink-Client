...
HomeWindow::HomeWindow(QWidget *parent)
    : QWidget(parent), ui(new Ui::HomeWindowClass()) {
  ui->setupUi(this);
  setParent(parent);
  ...
  connect(ui->modeButton, &QPushButton::clicked, this,
          &HomeWindow::onModeButton);
  connect(ui->logoffButton, &QPushButton::clicked, this,
          &HomeWindow::onLogoffButton);
  connect(ui->createRoomButton, &QPushButton::clicked, this,
          &HomeWindow::onCreatRoomButton);
  connect(ui->matchRoomButton, &QPushButton::clicked, this,
          &HomeWindow::onMatchRoomButton);
  connect(createRoomWindow, &CreateRoomWindow::backToHome, this,
          &HomeWindow::onBackFromCreateRoomWindow);
  connect(roomInfomationWindow, &RoomInfomationWindow::backToHome, this,
          &HomeWindow::onBackFromRoomInfomationWindow);
}
...
void HomeWindow::onLogoffButton() { emit logoffRequest(); }
...
void HomeWindow::onModeButton() { setMode(mode < 3 ? mode + 1 : 1); }
