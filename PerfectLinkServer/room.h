...
class Room : public QObject {
 ...
 public:
   ...
   * @return 构建的新房间
   */
  static Room *add(PlayerSocket *host, int playerLimit, int height, int width,
 ...
 private:
   ...
   */
  explicit Room(PlayerSocket *host, uint64_t id_, int playerLimit_, int height,
                int width, int patternNumber, int time,
